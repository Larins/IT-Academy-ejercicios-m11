...
public class MainMilestone2 {
	public static void main(String[] args) throws Exception {
		...
		do {
			...
			System.out.println("5  - Stock totes les botigues");
			System.out.println("6  - Stock per botiga");

			// System.out.println("6 - Sortir");
			try {
				opciomenu = opcio.nextInt();

				if (opciomenu > 0 && opciomenu <= 6) { // Adaptar if al nombre d' opcions
					...
					case 5: // Stock totes les botigues
					...
					case 6: // Stock per botiga
						...
						System.out.println("Stock de la floristera\n");
						store = (String) JOptionPane.showInputDialog(null, "Selecciona la floristeria",
								"Seleccionar floristeria", JOptionPane.QUESTION_MESSAGE, null, floristeriaObject,
								floristeriaObject[0]);
